...
## 5. Router Export Convention

All Express route files must use a default export for the router instance:

```ts
export default router;
```

Avoid named exports (e.g. `export const XyzRouter = router`) to keep imports consistent across modules.
