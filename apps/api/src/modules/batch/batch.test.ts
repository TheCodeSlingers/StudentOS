...
describe("BatchService", () => {
  ...
  describe("createBatch", () => {
    it("should successfully create a new batch in the workspace", async () => {
      const batch = await BatchService.createBatch(workspaceId, {
        name: "Cohort 1",
  ...
  describe("listBatches", () => {
    it("should list active batches within the workspace", async () => {
      const list = await BatchService.listBatches(workspaceId);
  ...
  describe("getBatch", () => {
    it("should return detailed batch info including metrics", async () => {
      const details = await BatchService.getBatch(workspaceId, batchId);
  ...
  describe("updateBatch", () => {
    it("should update batch details successfully", async () => {
      const updated = await BatchService.updateBatch(workspaceId, batchId, {
  ...
  describe("archiveBatch", () => {
    it("should toggle batch archived status successfully", async () => {
      const archived = await BatchService.archiveBatch(workspaceId, batchId);
